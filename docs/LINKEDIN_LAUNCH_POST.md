...
- Archives a tab locally before it can close
...
No account. No backend. No analytics. No cloud sync. Just a focused browser utility that keeps your tabs manageable without losing context.

I made a short product demo here: https://github.com/andrewkernel/tuck/blob/main/assets/demo/tabshelf-demo.webm

Source and local install instructions: https://github.com/andrewkernel/tuck

#ChromeExtension #ProductDesign #WebDevelopment #Privacy #Productivity
